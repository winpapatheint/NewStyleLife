        ...
        <div class="row justify-content-center">
            <div class="col-lg-8 col-md-10 col-sm-12">
                <div class="log-in-box">
                    ...
                    <div class="input-box">
                        <form method="POST" action="{{ route('admin.add_bank_account') }}" class="row g-4" id="addBankAccount">
                            @csrf
                            ...
                            <div class="col-md-12">
                                <button class="btn btn-animation theme-bg-color w-100" type="button" onclick="validateAddForm()">Add</button>
                            </div>
                        </form>
                    </div>
                </div>
...
<script>
    ...
    document.getElementById('addBankAccount').addEventListener('submit', function(event) {
