                                        ...
                                        <div class="mb-4 row align-items-center">
                                            ...
                                            <div class="col-sm-9">
                                                <input class="form-control" name="original_price" id="original_price"
                                                    type="number" min="1"
                                                    value="{{ $products->original_price }}" pattern="\d*">
                                            </div>
                                        </div>
                                        ...
                                        <div class="mb-4 row align-items-center">
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control" name="discount_percent" id="discount_percent"
                                                    ...
                                                    value="{{ $products->discount_percent }}" pattern="\d*">
                                            </div>
                                            <div class="col-sm-3">
                                                ...
                                                <input type="hidden" name="calculated_selling_price"
                                                    ...
                                                    value="{{ $products->calculated_selling_price }}" pattern="\d*">
                                            </div>
                                        </div>
                                        ...
                                        <div class="mb-4 row align-items-center">
                                            ...
                                            <div class="col-sm-9">
                                                <input class="form-control" name="product_qty" type="number"
                                                    min="1" value="{{ $products->product_qty }}" pattern="\d*">
                                            </div>
                                        </div>
                                        ...
                                        <div class="mb-4 row align-items-center">
                                            ...
                                            <div class="col-sm-9">
                                                <input class="form-control" name="delivery_price" type="number"
                                                    value="{{ $products->delivery_price }}" pattern="\d*">
                                            </div>
                                        </div>
